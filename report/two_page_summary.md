...
Suhail Mohamed Alhammali — ID 2200208522
...
Typesetting notes: wrap every decimal number in `\textenglish{}` so the
bidirectional algorithm does not reverse it. Do not use `---` anywhere on
these pages.

**تحليل إشارة الصوت باستخدام تعلّم الآلة للكشف المبكر عن مرض باركنسون**

سهيل محمد الحمالي — رقم القيد 2200208522
